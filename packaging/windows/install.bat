...
:err_nogame
echo   PROBLEM: Tropico.EXE is not here, and not in the folder above either.
echo.
echo   This ZIP must be extracted INTO your Tropico folder -- the one that
echo   already contains Tropico.EXE. Extracting it somewhere else entirely,
echo   or copying files in by hand, will not work.
echo.
echo   GOG    usually  C:\GOG Games\Tropico
